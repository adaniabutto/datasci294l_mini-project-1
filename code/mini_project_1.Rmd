...
*RMSE_model* = 0.472 vs *RMSE_baseline **=** .*496 (scale: percentage points in decimal
format, 0-1)
...
*RMSE_model* = 26.84 vs *RMSE_baseline **=*** 27.46 (scale: whole percentage points,
0-100)
...
For any item whose difficulty is around –1, the 2-PL yields about a coin-flip chance of
...
For easier items (difficulty \< –1) the model lets the learner do better than chance, and
for harder items (b \> –1) it lets them do worse.
